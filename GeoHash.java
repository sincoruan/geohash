...
public class GeoHash {
    ...
    public ArrayList<String> getArroundGeoHash(double lat, double lon) {
        ...
        //在当前纬度加减1个单元格，得到上邻纬度和下邻纬度
        double uplat = lat + minLat;
        double downLat = lat - minLat;

        //在当前经度加减1个单元格，得到上邻经度和下邻经度
    ...
    public static void main(String[] args) throws Exception {
        ...
        String s = geohash.encode(30.00, 116.248283);
        System.out.println(s);
        List<String> neighbors = geohash.getArroundGeoHash(40.222012, 116.248283);
